...
public class GLStateManager {
    ...
    public static final int MAX_ATTRIB_STACK_DEPTH = Math.max(GL11.glGetInteger(GL11.GL_MAX_ATTRIB_STACK_DEPTH), 16);
    public static final int MAX_MODELVIEW_STACK_DEPTH = Math.max(GL11.glGetInteger(GL11.GL_MAX_MODELVIEW_STACK_DEPTH), 32);
    public static final int MAX_PROJECTION_STACK_DEPTH = Math.max(GL11.glGetInteger(GL11.GL_MAX_PROJECTION_STACK_DEPTH), 32);
    public static final int MAX_TEXTURE_STACK_DEPTH = Math.max(GL11.glGetInteger(GL11.GL_MAX_TEXTURE_STACK_DEPTH), 16);
